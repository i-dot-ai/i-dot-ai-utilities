...
class Settings(BaseSettings):
    ...
    gcp_api_key: str = Field(default=None)
    azure_account_url: str = Field(default=None)
    azure_connection_string: str = Field(default=None)
    azure_account_key: str = Field(default=None)
